...
void timer2_pwm_init(void)
{
    ...
    TIM2_TimeBaseInit(TIM2_PRESCALER_8, 49);
...
//    TIM2_OC3Init(TIM2_OCMODE_PWM1, TIM2_OUTPUTSTATE_ENABLE, CCR1_Val, TIM2_OCPOLARITY_HIGH);
...
//	TIM2_TimeBaseInit(TIM2_PRESCALER_8, 49);
//	
//	TIM2_OC2Init(TIM2_OCMODE_PWM1, TIM2_OUTPUTSTATE_ENABLE, 25, TIM2_OCPOLARITY_HIGH);
//	TIM2_OC2PreloadConfig(ENABLE);
//        
